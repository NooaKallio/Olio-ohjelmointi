...
class MonenLaskija(Laskija):
    """Luokka, joka toteuttaa eri laskutoimituksia useammalle luvulle.
...
def argumenttien_tulostaja(**kwargs):
    """Tulostaa avainsana-argumenttien arvot.
